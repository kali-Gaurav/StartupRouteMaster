...
class ChatActionDispatcher:
    ...
    def __init__(self):
        ...
        self._pnr_breaker = circuit_manager.get_or_create(
            "chat_dispatcher_pnr",
            CircuitConfig(failure_threshold=5, timeout_seconds=30.0)
        )
        self._live_status_breaker = circuit_manager.get_or_create(
            "chat_dispatcher_live_status",
            CircuitConfig(failure_threshold=5, timeout_seconds=30.0)
        )
        self._booking_breaker = circuit_manager.get_or_create(
