...
class NexusResourceGovernor:
    ...
    """
    def __init__(self, cpu_limit: float = 95.0, ram_limit: float = 98.0):
        self.cpu_limit = cpu_limit
        self.ram_limit = ram_limit
        # [DEBUG] Allow test mode to bypass pressure checks
        self.test_mode = os.getenv("NEXUS_TEST_MODE", "0") == "1"
    ...
    def get_throttle_factor(self) -> float:
        """Synchronous access to the latest throttle factor for hot search loops."""
