...
from api.system.dependencies import require_role
...
async def get_system_health():
    ...
    from core.engines.control_plane import control_plane
...
async def get_circuit_breaker_status():
    from api.communication.chat import openrouter_breaker
