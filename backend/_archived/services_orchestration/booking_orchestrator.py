...
# Module-level circuit breakers and retry policies for decorator support
_booking_circuit_breaker = circuit_breaker(
    name="booking_orchestrator",
    failure_threshold=5,
    recovery_timeout=60.0
)
_flex_fallback_circuit_breaker = circuit_breaker(
    name="flex_fallback",
    failure_threshold=3,
    recovery_timeout=120.0
)
_booking_retry_policy = retry_policy(
    max_attempts=3,
    strategy=RetryStrategy.EXPONENTIAL_BACKOFF,
    base_delay=0.5,
    max_delay=10.0
)
_verification_retry_policy = retry_policy(
    max_attempts=2,
...
class BookingOrchestrator:
    ...
    def __init__(self, db: Session):
        ...
        self._metrics.gauge("booking_circuit_breaker_state", lambda: _booking_circuit_breaker.state.value)
        self._metrics.gauge("flex_fallback_circuit_breaker_state", lambda: _flex_fallback_circuit_breaker.state.value)
