...
async def handle_call_status(
    ...
    from api.safety.sos import _load_event_async, _save_event_async
...
async def trigger_voice_sos(payload: VoiceTriggerPayload):
    ...
    from api.safety.sos import _load_event_async, _save_event_async, PNR_REGISTRY_KEY, _get_redis_index_ids
    ...
    if match_found:
        ...
        # Trigger actual SOS
        from api.safety.sos import SOSPayload
        import uuid
