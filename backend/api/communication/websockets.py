...
from core.infrastructure.monitoring import WS_CONNECTIONS, WS_TRAIN_SUBSCRIPTIONS, WS_BROADCAST_ERRORS
...
class ConnectionManager:
    ...
    async def initialize(self):
        ...
        try:
            ...
            from core.infrastructure.monitoring import SYSTEM_DEGRADED_MODE
            ...
            from core.infrastructure.monitoring import REDIS_HEALTH_CHECKS, SYSTEM_DEGRADED_MODE
    ...
    async def _redis_listener(self):
        ...
        while True:
            try:
                ...
                from core.infrastructure.monitoring import REDIS_HEALTH_CHECKS
...
async def train_websocket_endpoint(
    ...
    await manager.connect(websocket, user_id=getattr(user, 'firebase_uid', None))
