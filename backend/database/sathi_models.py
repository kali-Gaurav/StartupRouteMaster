...
class Sathi(Base):
    ...
    # Service Areas
    service_stations: Mapped[List[str]] = mapped_column(JSON, default=[])
    service_routes: Mapped[List[str]] = mapped_column(JSON, default=[])
