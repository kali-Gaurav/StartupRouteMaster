...
class BookingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.InitiateBooking = channel.unary_unary(
                '/booking.BookingService/InitiateBooking',
        ...
        self.GetBookingStatus = channel.unary_unary(
                '/booking.BookingService/GetBookingStatus',
                request_serializer=booking__pb2.StatusRequest.SerializeToString,
...
def add_BookingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetBookingStatus': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=booking__pb2.StatusRequest.FromString,
...
class BookingService(object):
    ...
    def GetBookingStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/booking.BookingService/GetBookingStatus',
            booking__pb2.StatusRequest.SerializeToString,
