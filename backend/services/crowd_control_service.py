...
class CrowdControlService:
    ...
    async def _fetch_station_crowd(self, station_code: str) -> StationCrowdData:
        ...
        try:
            ...
            station_info = await station_service.get_station(station_code)
    ...
    async def _fetch_train_crowd(self, train_number: str, travel_date: date) -> TrainCrowdData:
        ...
        try:
            ...
            return TrainCrowdData(
                ...
                predicted_occupancy_at_departure=occupancy_rate * (1 - cancel_pred.predicted_rate),
                cancellation_probability=cancel_pred.predicted_rate
            )
    ...
    async def _find_best_wait_station(
        ...
        try:
            ...
            for station in route_stations:
                ...
                # Score based on amenities and crowd
                score = crowd.amenities_score * (1.0 - crowd.current_crowd_level.value * 0.3)
