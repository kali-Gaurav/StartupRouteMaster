...
from core.retry import RetryPolicy, retry_sync
...
class VerificationService:
    ...
    def __init__(self, config: Optional[VerificationConfig] = None):
        ...
        self._seat_breaker = circuit_breaker_manager.get_breaker("seat_verification")
        self._schedule_breaker = circuit_breaker_manager.get_breaker("schedule_verification")
        self._fare_breaker = circuit_breaker_manager.get_breaker("fare_verification")
...
class RouteVerificationEngine:
    ...
    def __init__(
        ...
        self._route_breaker = circuit_breaker_manager.get_breaker("route_verification")
    ...
    @circuit_breaker_manager.get_breaker("route_verification").decorate
    def verify_route(
        self,
        journey_id: str,
        train_number: str,
