...
class DelayService:
    ...
    def __init__(self, db: Session, config: Optional[DelayServiceConfig] = None):
        ...
        self._flex_breaker = circuit_manager.get_breaker("delay_service_flex")
        self._ws_breaker = circuit_manager.get_breaker("delay_service_ws")
    ...
    @circuit_manager.get_breaker("delay_service_flex").decorate
    @retry_async
    ...
    @circuit_manager.get_breaker("delay_service_ws").decorate
