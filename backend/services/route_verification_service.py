...
class RouteVerificationService:
    ...
    def __init__(self, config: Optional[RouteVerificationConfig] = None):
        ...
        self._seat_breaker = circuit_breaker_manager.get_breaker("route_verification_seat")
        self._live_breaker = circuit_breaker_manager.get_breaker("route_verification_live")
    ...
    @circuit_breaker_manager.get_breaker("route_verification_seat").decorate
    @retry_async
    ...
    @circuit_breaker_manager.get_breaker("route_verification_live").decorate
    @retry_async
